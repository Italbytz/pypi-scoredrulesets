...
Aufruf:
    python scripts/benchmark_exstracs_shrinking.py
    python scripts/benchmark_exstracs_shrinking.py --repeats 5
    python scripts/benchmark_exstracs_shrinking.py --datasets sklearn_iris,sklearn_wine
    python scripts/benchmark_exstracs_shrinking.py --quick   # nur sklearn-Datensätze, 1 Repeat
"""
...
def _recommendations(agg: list[AggResult]) -> str:
    ...
    lines.append("")
    lines.append("  Aktuell registrierte ExSTraCS-Varianten in estimators.py:")
    lines.append("    1. wrapper_exstracs                    (Baseline)")
    lines.append("    2. wrapper_exstracs_shrink_conservative")
    lines.append("    3. wrapper_exstracs_shrink_aggressive")
    lines.append("    4. wrapper_exstracs_shrink_filter      (Vollpipeline)")
    lines.append("    5. wrapper_exstracs_shrink_all")
    lines.append("")
