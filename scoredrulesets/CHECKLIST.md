...
#### 5. **Beispiele** ✅
- [x] `examples/estimators/example_rule_shrinking.py` - Kompletes Benchmark-Beispiel
...
python3 examples/benchmarks/benchmark_full_report.py \
  ...
  --datasets sklearn_iris --repeats 3
```
...
4. `examples/estimators/example_rule_shrinking.py` - Benchmark-Beispiel
