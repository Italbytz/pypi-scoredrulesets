...
- `examples/example_rule_shrinking.py` - Kompletes Benchmark-Beispiel
...
python examples/benchmark_runner.py \
  ...
  --output-csv benchmarks/2026-03-with-pruning/benchmark_results.csv \
  --output-markdown benchmarks/2026-03-with-pruning/benchmark_report.md
```
