...
- **warning_runs**: `0`
- **warning_models**: `0`
- **top_1_model**: `uci_wine / logicGP` (f1=0.9453, rules=7.3333, fit_s=5.0092)
...
- **best_model**: `logicGP` (f1=0.9453, rules=7.3333, fit_s=5.0092)
- **smallest_model**: `ruleLCS` (rules=4.3333, atoms=5.0000, f1=0.8972)
- **fastest_model**: `ruleLCS` (fit_s=0.1815, f1=0.8972, rules=4.3333)

### uci_breast_cancer_wisconsin_diagnostic

- **best_model**: `logicGP` (f1=0.9233, rules=5.0000, fit_s=7.0061)
- **smallest_model**: `ruleLCS` (rules=3.0000, atoms=4.0000, f1=0.8855)
- **fastest_model**: `ruleLCS` (fit_s=0.2933, f1=0.8855, rules=3.0000)

### uci_heart_disease

- **best_model**: `logicGP` (f1=0.7895, rules=8.0000, fit_s=8.2291)
- **smallest_model**: `ruleLCS` (rules=7.6667, atoms=13.0000, f1=0.6918)
- **fastest_model**: `ruleLCS` (fit_s=0.3515, f1=0.6918, rules=7.6667)
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | uci_wine | logicGP | 3 | 0.9453 | 0.0181 | 5.0092 | 7.3333 | 6.3333 |
| 2 | uci_breast_cancer_wisconsin_diagnostic | logicGP | 3 | 0.9233 | 0.0217 | 7.0061 | 5.0000 | 4.0000 |
| 3 | uci_wine | ruleLCS | 3 | 0.8972 | 0.0297 | 0.1815 | 4.3333 | 5.0000 |
| 4 | uci_breast_cancer_wisconsin_diagnostic | ruleLCS | 3 | 0.8855 | 0.0052 | 0.2933 | 3.0000 | 4.0000 |
| 5 | uci_heart_disease | logicGP | 3 | 0.7895 | 0.0619 | 8.2291 | 8.0000 | 7.3333 |
| 6 | uci_heart_disease | ruleLCS | 3 | 0.6918 | 0.0201 | 0.3515 | 7.6667 | 13.0000 |
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | uci_wine | logicGP | 3 | 0.9453 | 0.0181 | 5.0092 | 7.3333 | 6.3333 |
| 2 | uci_wine | ruleLCS | 3 | 0.8972 | 0.0297 | 0.1815 | 4.3333 | 5.0000 |
...
| rank | dataset | estimator | repeats | f1_mean | f1_err | fit_s | rules | atoms |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | uci_breast_cancer_wisconsin_diagnostic | logicGP | 3 | 0.9233 | 0.0217 | 7.0061 | 5.0000 | 4.0000 |
| 2 | uci_breast_cancer_wisconsin_diagnostic | ruleLCS | 3 | 0.8855 | 0.0052 | 0.2933 | 3.0000 | 4.0000 |
...
| rank | dataset | estimator | repeats | f1_mean | f1_err | fit_s | rules | atoms |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | uci_heart_disease | logicGP | 3 | 0.7895 | 0.0619 | 8.2291 | 8.0000 | 7.3333 |
| 2 | uci_heart_disease | ruleLCS | 3 | 0.6918 | 0.0201 | 0.3515 | 7.6667 | 13.0000 |
