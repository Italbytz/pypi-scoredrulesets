...
- **warning_runs**: `0`
- **warning_models**: `0`
- **top_1_model**: `uci_wine / ruleGP2 (tournament=2)` (f1=0.9525, rules=5.0000, fit_s=10.0441)

## Configuration

- **datasets**: `sklearn_wine, uci_heart_disease, synth_checkerboard_4x4`
- **estimators**: `ruleGP2, ruleGP2 (tournament=2)`
- **repeats**: `3`
...
- **best_model**: `ruleGP2 (tournament=2)` (f1=0.9525, rules=5.0000, fit_s=10.0441)
- **smallest_model**: `ruleGP2` (rules=4.0000, atoms=3.0000, f1=0.9154)
- **fastest_model**: `ruleGP2` (fit_s=7.2152, f1=0.9154, rules=4.0000)

### uci_heart_disease

- **best_model**: `ruleGP2` (f1=0.7378, rules=3.6667, fit_s=10.2042)
- **smallest_model**: `ruleGP2 (tournament=2)` (rules=2.6667, atoms=1.6667, f1=0.7183)
- **fastest_model**: `ruleGP2 (tournament=2)` (fit_s=7.3579, f1=0.7183, rules=2.6667)

### synth_checkerboard_4x4

- **best_model**: `ruleGP2 (tournament=2)` (f1=0.5187, rules=3.6667, fit_s=18.9302)
- **smallest_model**: `ruleGP2` (rules=3.0000, atoms=2.3333, f1=0.4990)
- **fastest_model**: `ruleGP2` (fit_s=11.9485, f1=0.4990, rules=3.0000)
...
| estimator | f1_mean | atoms | rules |
| --- | ---: | ---: | ---: |
| ruleGP2 (tournament=2) | 0.5187 | 2.6667 | 3.6667 |
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | uci_wine | ruleGP2 (tournament=2) | 3 | 0.9525 | 0.0110 | 10.0441 | 5.0000 | 4.0000 |
| 2 | uci_wine | ruleGP2 | 3 | 0.9154 | 0.0454 | 7.2152 | 4.0000 | 3.0000 |
| 3 | uci_heart_disease | ruleGP2 | 3 | 0.7378 | 0.0161 | 10.2042 | 3.6667 | 3.3333 |
| 4 | uci_heart_disease | ruleGP2 (tournament=2) | 3 | 0.7183 | 0.0197 | 7.3579 | 2.6667 | 1.6667 |
| 5 | synth_checkerboard_4x4 | ruleGP2 (tournament=2) | 3 | 0.5187 | 0.0241 | 18.9302 | 3.6667 | 2.6667 |
| 6 | synth_checkerboard_4x4 | ruleGP2 | 3 | 0.4990 | 0.0255 | 11.9485 | 3.0000 | 2.3333 |
...
| rank | dataset | estimator | repeats | f1_mean | f1_err | fit_s | rules | atoms |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | uci_heart_disease | ruleGP2 | 3 | 0.7378 | 0.0161 | 10.2042 | 3.6667 | 3.3333 |
| 2 | uci_heart_disease | ruleGP2 (tournament=2) | 3 | 0.7183 | 0.0197 | 7.3579 | 2.6667 | 1.6667 |
...
| rank | dataset | estimator | repeats | f1_mean | f1_err | fit_s | rules | atoms |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | synth_checkerboard_4x4 | ruleGP2 (tournament=2) | 3 | 0.5187 | 0.0241 | 18.9302 | 3.6667 | 2.6667 |
| 2 | synth_checkerboard_4x4 | ruleGP2 | 3 | 0.4990 | 0.0255 | 11.9485 | 3.0000 | 2.3333 |
