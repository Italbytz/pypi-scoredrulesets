...
- **warning_runs**: `0`
- **warning_models**: `0`
- **top_1_model**: `uci_wine / ruleGP2` (f1=0.9652, rules=4.0000, fit_s=1.0299)
...
- **best_model**: `ruleGP2` (f1=0.9652, rules=4.0000, fit_s=1.0299)
- **smallest_model**: `ruleGP2` (rules=4.0000, atoms=3.0000, f1=0.9652)
- **fastest_model**: `ruleGP2` (fit_s=1.0299, f1=0.9652, rules=4.0000)

### uci_heart_disease

- **best_model**: `logicGP` (f1=0.7337, rules=8.0000, fit_s=8.3128)
- **smallest_model**: `ruleGP2` (rules=2.0000, atoms=1.0000, f1=0.6961)
- **fastest_model**: `ruleGP2` (fit_s=1.1700, f1=0.6961, rules=2.0000)

### synth_checkerboard_4x4

- **best_model**: `logicGP` (f1=0.6938, rules=3.0000, fit_s=4.1830)
- **smallest_model**: `ruleGP2` (rules=3.0000, atoms=2.0000, f1=0.4696)
- **fastest_model**: `ruleGP2` (fit_s=2.2954, f1=0.4696, rules=3.0000)
...
| ruleGP2 | 0.4696 | 2.0000 | 3.0000 |

## Leaderboard

| rank | dataset | estimator | repeats | f1_mean | f1_err | fit_s | rules | atoms |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | uci_wine | ruleGP2 | 1 | 0.9652 | 0.0000 | 1.0299 | 4.0000 | 3.0000 |
| 2 | uci_wine | logicGP | 1 | 0.9450 | 0.0000 | 4.5495 | 7.0000 | 6.0000 |
| 3 | uci_heart_disease | logicGP | 1 | 0.7337 | 0.0000 | 8.3128 | 8.0000 | 7.0000 |
| 4 | uci_heart_disease | ruleGP2 | 1 | 0.6961 | 0.0000 | 1.1700 | 2.0000 | 1.0000 |
| 5 | synth_checkerboard_4x4 | logicGP | 1 | 0.6938 | 0.0000 | 4.1830 | 3.0000 | 4.0000 |
| 6 | synth_checkerboard_4x4 | ruleGP2 | 1 | 0.4696 | 0.0000 | 2.2954 | 3.0000 | 2.0000 |
...
| rank | dataset | estimator | repeats | f1_mean | f1_err | fit_s | rules | atoms |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | uci_heart_disease | logicGP | 1 | 0.7337 | 0.0000 | 8.3128 | 8.0000 | 7.0000 |
| 2 | uci_heart_disease | ruleGP2 | 1 | 0.6961 | 0.0000 | 1.1700 | 2.0000 | 1.0000 |
...
| rank | dataset | estimator | repeats | f1_mean | f1_err | fit_s | rules | atoms |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | synth_checkerboard_4x4 | logicGP | 1 | 0.6938 | 0.0000 | 4.1830 | 3.0000 | 4.0000 |
| 2 | synth_checkerboard_4x4 | ruleGP2 | 1 | 0.4696 | 0.0000 | 2.2954 | 3.0000 | 2.0000 |
