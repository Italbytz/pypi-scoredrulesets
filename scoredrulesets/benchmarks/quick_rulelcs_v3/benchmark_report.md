...
- **warning_runs**: `0`
- **warning_models**: `0`
- **top_1_model**: `uci_wine / logicGP` (f1=0.9453, rules=7.3333, fit_s=4.9982)
...
- **best_model**: `logicGP` (f1=0.9453, rules=7.3333, fit_s=4.9982)
- **smallest_model**: `ruleLCS` (rules=3.3333, atoms=4.0000, f1=0.8978)
- **fastest_model**: `ruleLCS` (fit_s=0.1828, f1=0.8978, rules=3.3333)

### uci_breast_cancer_wisconsin_diagnostic

- **best_model**: `logicGP` (f1=0.9233, rules=5.0000, fit_s=6.8099)
- **smallest_model**: `ruleLCS` (rules=2.3333, atoms=2.0000, f1=0.8831)
- **fastest_model**: `ruleLCS` (fit_s=0.2929, f1=0.8831, rules=2.3333)

### uci_heart_disease

- **best_model**: `logicGP` (f1=0.7895, rules=8.0000, fit_s=8.2102)
- **smallest_model**: `ruleLCS` (rules=3.6667, atoms=6.0000, f1=0.7165)
- **fastest_model**: `ruleLCS` (fit_s=0.3638, f1=0.7165, rules=3.6667)
...
| ruleLCS | 0.7165 | 6.0000 | 3.6667 |

## Leaderboard

| rank | dataset | estimator | repeats | f1_mean | f1_err | fit_s | rules | atoms |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | uci_wine | logicGP | 3 | 0.9453 | 0.0181 | 4.9982 | 7.3333 | 6.3333 |
| 2 | uci_breast_cancer_wisconsin_diagnostic | logicGP | 3 | 0.9233 | 0.0217 | 6.8099 | 5.0000 | 4.0000 |
| 3 | uci_wine | ruleLCS | 3 | 0.8978 | 0.0290 | 0.1828 | 3.3333 | 4.0000 |
| 4 | uci_breast_cancer_wisconsin_diagnostic | ruleLCS | 3 | 0.8831 | 0.0090 | 0.2929 | 2.3333 | 2.0000 |
| 5 | uci_heart_disease | logicGP | 3 | 0.7895 | 0.0619 | 8.2102 | 8.0000 | 7.3333 |
| 6 | uci_heart_disease | ruleLCS | 3 | 0.7165 | 0.0250 | 0.3638 | 3.6667 | 6.0000 |
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | uci_wine | logicGP | 3 | 0.9453 | 0.0181 | 4.9982 | 7.3333 | 6.3333 |
| 2 | uci_wine | ruleLCS | 3 | 0.8978 | 0.0290 | 0.1828 | 3.3333 | 4.0000 |
...
| rank | dataset | estimator | repeats | f1_mean | f1_err | fit_s | rules | atoms |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | uci_breast_cancer_wisconsin_diagnostic | logicGP | 3 | 0.9233 | 0.0217 | 6.8099 | 5.0000 | 4.0000 |
| 2 | uci_breast_cancer_wisconsin_diagnostic | ruleLCS | 3 | 0.8831 | 0.0090 | 0.2929 | 2.3333 | 2.0000 |
...
| rank | dataset | estimator | repeats | f1_mean | f1_err | fit_s | rules | atoms |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | uci_heart_disease | logicGP | 3 | 0.7895 | 0.0619 | 8.2102 | 8.0000 | 7.3333 |
| 2 | uci_heart_disease | ruleLCS | 3 | 0.7165 | 0.0250 | 0.3638 | 3.6667 | 6.0000 |
